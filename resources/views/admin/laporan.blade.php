...
<body class="bg-slate-100 text-black font-sans p-6 sm:p-12 print-padding">
    <div class="max-w-6xl mx-auto mb-6 bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between no-print">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('admin.umkm') }}"class="px-4 py-2 rounded-lg text-xs font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 transition-colors">Kembali</a>
            <button onclick="window.print()"class="px-5 py-2 rounded-lg text-xs font-bold text-white bg-primary-600 hover:bg-primary-700 transition-colors shadow-md shadow-primary-100">Cetak Laporan</button>
        </div>
    </div>
    ...
    <div class="max-w-6xl mx-auto bg-white p-8 sm:p-12 shadow-lg print:shadow-none report-font printable-sheet">
            ...
            <div class="space-y-3">
                <div class="flex items-center justify-center relative">
                    <div class="flex items-center">
                        <img src="{{ asset('logo-bandung.png') }}"
                             alt="Logo Kabupaten Bandung"
                             class="w-20 h-20 object-contain mr-5 shrink-0">
                        <div class="text-center">
                            <h3 class="font-bold uppercase tracking-wider text-black"
                                style="font-size: 15px !important; line-height: 1.2;">
                                Pemerintah Kabupaten Bandung
                            </h3>
                            <h2 class="font-extrabold uppercase tracking-wide text-black mt-0.5"
                                style="font-size: 15px !important; line-height: 1.2;">
                                Kecamatan Cicalengka
                            </h2>
                            <h1 class="font-black uppercase tracking-widest text-black mt-0.5"
                                style="font-size: 19px !important; line-height: 1.2;">
                                Seksi Pemberdayaan Masyarakat
                            </h1>
                            <p class="text-black mt-1.5 italic"style="font-size: 8.5px !important; line-height: 1.3;">Jl. Raya Timur Cicalengka No. 344 Kabupaten Bandung Telp. 0227949205 Email :<br>kec.cicalengka@bandungkab.go.id Website : kecamatancicalengka.bandungkab.go.id</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse border border-black text-xs text-black">
                    ...
                    <tbody class="divide-y divide-black text-black">
                        ...
                        @empty
                            <tr>
                                <td colspan="10"class="py-6 px-3 border border-black text-center text-black">Belum ada data pelaku UMKM terdaftar yang terverifikasi untuk wilayah desa ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="mt-10 signature-block text-black">
            <div class="mt-4 mb-8 text-right text-xs font-semibold text-black">
                <p>Cicalengka, {{ now()->locale('id')->translatedFormat('d F Y') }}</p>
            </div>

            <table class="w-full border-collapse text-xs font-semibold text-black">
                <tr>
                    <td class="w-1/2 text-center align-top px-8 text-black">
                        <p class="font-bold text-black">Kepala Seksi Pemberdayaan Masyarakat</p>
                        <div class="h-20"></div>
                        <div class="text-center text-black">
                            <p class="font-bold text-black"><span class="underline underline-offset-2">....................................................</span></p>
                            <p class="text-[10px] text-black font-medium mt-1">NIP. ....................................................</p>
                        </div>
                    </td>
