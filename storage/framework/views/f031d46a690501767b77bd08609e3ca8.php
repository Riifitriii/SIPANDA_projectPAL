...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SIPANDA - Kecamatan Cicalengka'); ?></title>
    ...
    <header class="sticky top-0 z-50 glass-nav transition-all duration-300">
            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center space-x-3">
                    <a href="<?php echo e(route('landing')); ?>" class="flex items-center space-x-3 group">
                        <img src="<?php echo e(asset('logo-icon.png')); ?>?v=3" alt="SIPANDA Logo" class="w-12 h-12 object-contain rounded-full bg-white p-0.5 border border-slate-200 shadow-sm group-hover:scale-105 transition-transform duration-300">
                        <div>
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="<?php echo e(route('landing')); ?>#hero" class="text-sm font-semibold text-secondary-600 hover:text-primary-600 transition-colors duration-200">Beranda</a>
                    <a href="<?php echo e(route('landing')); ?>#tentang" class="text-sm font-semibold text-secondary-600 hover:text-primary-600 transition-colors duration-200">Tentang</a>
                    <a href="<?php echo e(route('landing')); ?>#alur" class="text-sm font-semibold text-secondary-600 hover:text-primary-600 transition-colors duration-200">Alur</a>
                    <a href="<?php echo e(route('landing')); ?>#syarat" class="text-sm font-semibold text-secondary-600 hover:text-primary-600 transition-colors duration-200">Syarat</a>
                    <a href="<?php echo e(route('cek-status')); ?>" class="text-sm font-semibold text-secondary-600 hover:text-primary-600 transition-colors duration-200">Cek Status</a>
                    <a href="<?php echo e(route('ajukan')); ?>" class="inline-flex items-center justify-center px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-primary-600 to-emerald-500 hover:from-primary-700 hover:to-emerald-600 shadow-md shadow-primary-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
                        Ajukan Pendataan
                    </a>
                </nav>
        ...
        <div class="hidden md:hidden border-b border-slate-100 bg-white" id="mobile-menu">
            <div class="px-4 pt-2 pb-6 space-y-3">
                <a href="<?php echo e(route('landing')); ?>#hero" onclick="toggleMobileMenu()" class="block px-4 py-2.5 rounded-xl text-base font-semibold text-secondary-700 hover:bg-slate-50 hover:text-primary-600 transition-colors">Beranda</a>
                <a href="<?php echo e(route('landing')); ?>#tentang" onclick="toggleMobileMenu()" class="block px-4 py-2.5 rounded-xl text-base font-semibold text-secondary-700 hover:bg-slate-50 hover:text-primary-600 transition-colors">Tentang</a>
                <a href="<?php echo e(route('landing')); ?>#alur" onclick="toggleMobileMenu()" class="block px-4 py-2.5 rounded-xl text-base font-semibold text-secondary-700 hover:bg-slate-50 hover:text-primary-600 transition-colors">Alur</a>
                <a href="<?php echo e(route('landing')); ?>#syarat" onclick="toggleMobileMenu()" class="block px-4 py-2.5 rounded-xl text-base font-semibold text-secondary-700 hover:bg-slate-50 hover:text-primary-600 transition-colors">Syarat</a>
                <a href="<?php echo e(route('cek-status')); ?>" onclick="toggleMobileMenu()" class="block px-4 py-2.5 rounded-xl text-base font-semibold text-secondary-700 hover:bg-slate-50 hover:text-primary-600 transition-colors">Cek Status</a>
                <div class="pt-2">
                    <a href="<?php echo e(route('ajukan')); ?>" onclick="toggleMobileMenu()" class="block w-full text-center px-4 py-3 rounded-xl text-base font-semibold text-white bg-gradient-to-r from-primary-600 to-emerald-500 hover:from-primary-700 hover:to-emerald-600 shadow-md transition-all">
                        Ajukan Pendataan
                    </a>
                </div>
            </div>
    ...
    <footer class="bg-secondary-900 text-slate-400 py-16 border-t border-slate-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        <img src="<?php echo e(asset('logo-icon.png')); ?>?v=3" alt="SIPANDA Logo" class="w-10 h-10 object-contain rounded-full bg-white p-0.5 border border-slate-850">
                    ...
                    <p class="text-xs text-slate-500">
                        &copy; <?php echo e(date('Y')); ?> Seksi Pemberdayaan Masyarakat Kecamatan Cicalengka. All rights reserved.
                    </p>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2.5 text-sm text-slate-400">
                        ...
                        <li><a href="<?php echo e(route('admin.login')); ?>" class="hover:text-primary-400 transition-colors flex items-center space-x-1.5">
...
<?php /**PATH C:\Users\ADVAN\Downloads\sipanda\resources\views/layouts/app.blade.php ENDPATH**/ ?>