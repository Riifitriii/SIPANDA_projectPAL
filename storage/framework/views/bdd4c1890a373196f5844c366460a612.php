...
<body class="bg-secondary-900 min-h-screen flex items-center justify-center p-4 relative overflow-hidden antialiased">
    ...
    <div class="w-full max-w-md bg-white rounded-3xl p-8 border border-slate-100 shadow-2xl space-y-8">
        ...
        <div class="text-center space-y-2.5">
            <img src="<?php echo e(asset('logo-icon.png')); ?>?v=3" alt="SIPANDA Logo" class="w-16 h-16 object-contain rounded-full bg-white p-1 border border-slate-200 shadow-md mx-auto">
        ...
        <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" required placeholder="admin@cicalengka.go.id" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all">
            </div>
        ...
        <div class="text-center pt-2">
            <a href="<?php echo e(route('landing')); ?>" class="text-xs font-bold text-secondary-500 hover:text-primary-600">
...
<?php /**PATH C:\Users\ADVAN\Downloads\sipanda\resources\views/admin/login.blade.php ENDPATH**/ ?>