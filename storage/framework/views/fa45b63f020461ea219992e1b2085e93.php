<?php $__env->startSection('title', 'SIPANDA - Sistem Informasi Pengajuan & Pendataan UMKM Cicalengka'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-7 space-y-8 text-center lg:text-left">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                    <a href="<?php echo e(route('ajukan')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 rounded-2xl text-base font-bold text-white bg-gradient-to-r from-primary-600 to-emerald-500 hover:from-primary-700 hover:to-emerald-600 shadow-lg shadow-primary-200 transition-all duration-300 hover:-translate-y-1">
                        <!-- Send/Arrow Icon -->
                    ...
                    <a href="<?php echo e(route('cek-status')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 rounded-2xl text-base font-bold text-secondary-700 bg-white border-2 border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-all duration-300 hover:-translate-y-1">
                        <!-- Search Icon -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div class="group bg-slate-50 hover:bg-white rounded-3xl p-8 border border-slate-100 hover:border-primary-100 hover:shadow-xl transition-all duration-300 space-y-5">
                ...
                <h3 class="text-xl font-bold text-secondary-900">Legalitas & Basis Data</h3>
                <p class="text-sm text-secondary-600 leading-relaxed">
                    Membantu pencatatan administratif usaha Anda di database Seksi Pemberdayaan Masyarakat Kecamatan Cicalengka secara legal dan terstruktur.
                </p>
            </div>
            ...
            <div class="group bg-slate-50 hover:bg-white rounded-3xl p-8 border border-slate-100 hover:border-primary-100 hover:shadow-xl transition-all duration-300 space-y-5">
                <div class="w-12 h-12 rounded-2xl bg-primary-100 text-primary-700 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M10.34 15.84c-.685-.34-1.386-.683-2.071-1.026a2.25 2.25 0 0 0-2.234 0l-2.071 1.026a2.25 2.25 0 0 0-1.07 1.916v1.944a2.25 2.25 0 0 0 2.25 2.25h13.75a2.25 2.25 0 0 0 2.25-2.25v-1.944a2.25 2.25 0 0 0-1.07-1.916l-2.07-1.026a2.25 2.25 0 0 0-2.235 0l-2.071 1.026a2.25 2.25 0 0 1-2.07 0ZM15.75 9a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold text-secondary-900">Program Pemberdayaan</h3>
                <p class="text-sm text-secondary-600 leading-relaxed">
                    UMKM yang terdata menjadi prioritas utama dalam mendapatkan program pelatihan, pembinaan, sertifikasi produk, bantuan modal, dan pameran.
                </p>
            </div>
            ...
            <div class="group bg-slate-50 hover:bg-white rounded-3xl p-8 border border-slate-100 hover:border-primary-100 hover:shadow-xl transition-all duration-300 space-y-5">
                ...
                <h3 class="text-xl font-bold text-secondary-900">Promosi & Ekspansi</h3>
                <p class="text-sm text-secondary-600 leading-relaxed">
                    Meningkatkan kredibilitas bisnis Anda untuk kolaborasi program kabupaten, instansi lain, serta kemudahan akses pembinaan pasar.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <div class="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm text-center relative hover:shadow-md transition-shadow">
                <span class="absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 rounded-full bg-primary-600 text-white font-bold flex items-center justify-center shadow-md">1</span>
                ...
                <h3 class="text-lg font-bold text-secondary-900 mb-2">Isi Form Pengajuan</h3>
                <p class="text-sm text-secondary-500 leading-relaxed">
                    Lengkapi informasi data pemilik, detail usaha, lokasi, serta unggah foto pendukung usaha Anda melalui form pengajuan.
                </p>
            </div>

            <!-- Step 2 -->
            <div class="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm text-center relative hover:shadow-md transition-shadow">
                <span class="absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 rounded-full bg-primary-600 text-white font-bold flex items-center justify-center shadow-md">2</span>
                <div class="w-14 h-14 rounded-2xl bg-primary-50 flex items-center justify-center text-primary-600 mx-auto mb-6 mt-2">
                    <!-- Verify Check icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
                ...
                <h3 class="text-lg font-bold text-secondary-900 mb-2">Verifikasi Admin</h3>
                <p class="text-sm text-secondary-500 leading-relaxed">
                    Admin Seksi Pemberdayaan Masyarakat akan memeriksa dan memvalidasi berkas administrasi serta foto lokasi secara berkala.
                </p>
            </div>

            <!-- Step 3 -->
            <div class="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm text-center relative hover:shadow-md transition-shadow">
                <span class="absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 rounded-full bg-primary-600 text-white font-bold flex items-center justify-center shadow-md">3</span>
                <div class="w-14 h-14 rounded-2xl bg-primary-50 flex items-center justify-center text-primary-600 mx-auto mb-6 mt-2">
                    <!-- Map/Data icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.109A2.25 2.25 0 0112.75 21.5h-1.5a2.25 2.25 0 01-2.25-2.25v-.109m0-2.178a9.38 9.38 0 00-2.625.372 9.337 9.337 0 00-4.121.952 4.125 4.125 0 007.533 2.493M9 19.128v-.003c0-1.113.285-2.16.786-3.07M15 12.25A3.375 3.375 0 0011.625 9H8.25m6.75 3.25a3.375 3.375 0 11-6.75 0M9 3.75h.008v.008H9V3.75Zm.75 0a.75.75 0 11-1.5 0 .75.75 0 0 1 1.5 0ZM9 7.5h.008v.008H9V7.5Zm.75 0a.75.75 0 11-1.5 0 .75.75 0 0 1 1.5 0Z" />
                    </svg>
                </div>
                <h3 class="text-lg font-bold text-secondary-900 mb-2">Terdata Resmi</h3>
                <p class="text-sm text-secondary-500 leading-relaxed">
                    Setelah disetujui, data UMKM akan otomatis terdaftar secara resmi di Kecamatan dan dapat diunduh/dicetak sebagai laporan berkala.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-7 bg-slate-50 rounded-3xl p-8 border border-slate-100 shadow-sm space-y-6">
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <h4 class="font-bold text-secondary-900">Lokasi Usaha di Kecamatan Cicalengka</h4>
                        <p class="text-xs text-secondary-500 mt-1">Usaha berlokasi fisik di wilayah administratif salah satu dari 12 desa di Kecamatan Cicalengka.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <h4 class="font-bold text-secondary-900">Kepemilikan dan Kontak Valid</h4>
                        <p class="text-xs text-secondary-500 mt-1">Nama pemilik merupakan nama asli sesuai KTP. Wajib menyertakan nomor telepon/WhatsApp aktif yang dapat dihubungi oleh petugas.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <h4 class="font-bold text-secondary-900">Dokumentasi Foto Usaha</h4>
                        <p class="text-xs text-secondary-500 mt-1">Siapkan foto produk utama, proses produksi, atau tampak depan fisik toko. Format file gambar berupa JPG, JPEG, PNG, atau WEBP dengan ukuran file maksimal 2 MB.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <h4 class="font-bold text-secondary-900">Keterangan Usaha Jelas</h4>
                        <p class="text-xs text-secondary-500 mt-1">Menjelaskan nama usaha, deskripsi barang/jasa yang dijual, alamat lengkap, dan jenis kategori usaha dengan jujur dan aktual.</p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Call to Action -->
<section class="bg-gradient-to-tr from-secondary-900 to-primary-950 text-white py-20 relative overflow-hidden">
    <!-- Grid elements -->
    <div class="absolute inset-0 bg-[linear-gradient(to_right,#1f2937_1px,transparent_1px),linear-gradient(to_bottom,#1f2937_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-30"></div>
    ...
    <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 space-y-8 relative z-10">
        ...
        <div class="flex justify-center">
            <a href="<?php echo e(route('ajukan')); ?>" class="inline-flex items-center justify-center px-8 py-4 rounded-2xl text-base font-bold text-secondary-900 bg-gradient-to-r from-primary-400 to-emerald-300 hover:from-primary-500 hover:to-emerald-400 shadow-xl transition-all duration-300 hover:-translate-y-1">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADVAN\Downloads\sipanda\resources\views/landing.blade.php ENDPATH**/ ?>