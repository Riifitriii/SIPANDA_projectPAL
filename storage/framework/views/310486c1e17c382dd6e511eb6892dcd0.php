<?php $__env->startSection('title', 'Form Pengajuan Pendataan UMKM - SIPANDA Cicalengka'); ?>
...
<section class="py-16 bg-slate-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php if(session('success_submission')): ?>
        <!-- Success Card -->
        <div class="bg-white rounded-3xl p-8 border border-primary-200 shadow-xl shadow-primary-50/50 mb-8 border-l-8 border-l-primary-600 animate-fadeIn space-y-6">
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-2xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    ...
                    <span class="text-2xl font-black text-primary-700 tracking-wider block" id="nomor-copy"><?php echo e(session('success_submission')['nomor_pengajuan']); ?></span>
                </div>
            ...
            <div class="bg-primary-50 rounded-2xl p-5 border border-primary-100/50 space-y-2">
                ...
                <ul class="text-xs text-primary-800 space-y-1">
                    <li><strong>Nama Usaha:</strong> <?php echo e(session('success_submission')['nama_usaha']); ?></li>
                    <li><strong>Nama Pemilik:</strong> <?php echo e(session('success_submission')['nama_pemilik']); ?></li>
                    <li><strong>Status Awal:</strong> Menunggu Verifikasi (Proses validasi membutuhkan 1-3 hari kerja)</li>
                </ul>
            </div>

            <div class="flex justify-end pt-2">
                <a href="<?php echo e(route('cek-status')); ?>" class="inline-flex items-center text-sm font-bold text-primary-600 hover:text-primary-700">
        ...
        <!-- Form Pengajuan -->
        <form action="<?php echo e(route('ajukan.submit')); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-md space-y-10">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nama_pemilik" id="nama_pemilik" value="<?php echo e(old('nama_pemilik')); ?>" placeholder="Contoh: Asep Sunandar" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['nama_pemilik'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_telepon" id="nomor_telepon" value="<?php echo e(old('nomor_telepon')); ?>" placeholder="Contoh: 081234567890" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['nomor_telepon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:ring-red-400 <?php unset($message);
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nama_usaha" id="nama_usaha" value="<?php echo e(old('nama_usaha')); ?>" placeholder="Contoh: Keripik Singkong Cicalengka" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['nama_usaha'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="jenis_usaha" id="jenis_usaha" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['jenis_usaha'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="Kuliner (Makanan & Minuman)" <?php echo e(old('jenis_usaha') == 'Kuliner (Makanan & Minuman)' ? 'selected' : ''); ?>>Kuliner (Makanan & Minuman)</option>
                            <option value="Kriya & Kerajinan Tangan" <?php echo e(old('jenis_usaha') == 'Kriya & Kerajinan Tangan' ? 'selected' : ''); ?>>Kriya & Kerajinan Tangan</option>
                            <option value="Fashion & Konveksi" <?php echo e(old('jenis_usaha') == 'Fashion & Konveksi' ? 'selected' : ''); ?>>Fashion & Konveksi</option>
                            <option value="Pertanian & Peternakan" <?php echo e(old('jenis_usaha') == 'Pertanian & Peternakan' ? 'selected' : ''); ?>>Pertanian & Peternakan</option>
                            <option value="Jasa & Perdagangan" <?php echo e(old('jenis_usaha') == 'Jasa & Perdagangan' ? 'selected' : ''); ?>>Jasa & Perdagangan</option>
                            <option value="Kecantikan & Kesehatan" <?php echo e(old('jenis_usaha') == 'Kecantikan & Kesehatan' ? 'selected' : ''); ?>>Kecantikan & Kesehatan</option>
                            <option value="Lainnya" <?php echo e(old('jenis_usaha') == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nib" id="nib" value="<?php echo e(old('nib')); ?>" placeholder="Contoh: 9120001234567" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['nib'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="sertifikasi_halal" id="sertifikasi_halal" value="<?php echo e(old('sertifikasi_halal')); ?>" placeholder="Contoh: ID32110001234567890" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['sertifikasi_halal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        <?php $__errorArgs = ['sertifikasi_halal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="deskripsi_usaha" id="deskripsi_usaha" rows="4" placeholder="Jelaskan produk yang Anda jual, keunggulan usaha, proses pembuatan, atau model pelayanan usaha Anda..." class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['deskripsi_usaha'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('deskripsi_usaha')); ?></textarea>
                    <?php $__errorArgs = ['deskripsi_usaha'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select name="desa" id="desa" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['desa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $desaList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($d); ?>" <?php echo e(old('desa') == $d ? 'selected' : ''); ?>><?php echo e($d); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="alamat_lengkap" id="alamat_lengkap" rows="3" placeholder="Contoh: Jl. Dipatiukur No. 12, RT 02 RW 05 (Samping Masjid Al-Hidayah)" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all <?php $__errorArgs = ['alamat_lengkap'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-end gap-3">
                <a href="<?php echo e(route('landing')); ?>" class="w-full sm:w-auto text-center px-6 py-3 rounded-xl text-sm font-semibold text-secondary-600 hover:bg-slate-100 transition-colors">
                    Batal
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADVAN\Downloads\sipanda\resources\views/ajukan.blade.php ENDPATH**/ ?>