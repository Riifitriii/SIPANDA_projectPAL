...
<body class="bg-slate-100 text-slate-800 font-sans p-6 sm:p-12 print-padding">
    ...
    <div class="max-w-6xl mx-auto mb-6 bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between no-print">
        ...
        <div class="flex items-center space-x-3">
            <a href="<?php echo e(route('admin.umkm')); ?>" class="px-4 py-2 rounded-lg text-xs font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 transition-colors">
                Kembali
            </a>
    ...
    <div class="max-w-6xl mx-auto bg-white p-8 sm:p-12 border border-slate-200 shadow-lg print:border-none print:shadow-none min-h-screen flex flex-col justify-between">
        ...
        <div class="space-y-8">
            ...
            <div class="text-center space-y-1">
                ...
                <p class="text-xs text-slate-600">Wilayah Desa: <strong><?php echo e($selectedDesa); ?></strong> | Per Tanggal: <strong><?php echo e(date('d F Y')); ?></strong></p>
            </div>
                    ...
                    <tbody class="divide-y divide-slate-300">
                        <?php $__empty_1 = true; $__currentLoopData = $umkms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50/50">
                                <td class="py-2 px-3 border border-slate-300 text-center font-medium"><?php echo e($index + 1); ?></td>
                                <td class="py-2 px-3 border border-slate-300 font-mono font-semibold"><?php echo e($u->nomor_pengajuan); ?></td>
                                <td class="py-2 px-3 border border-slate-300 font-bold"><?php echo e($u->nama_usaha); ?></td>
                                <td class="py-2 px-3 border border-slate-300 font-medium"><?php echo e($u->nama_pemilik); ?></td>
                                <td class="py-2 px-3 border border-slate-300 font-mono"><?php echo e($u->nib ?? '-'); ?></td>
                                <td class="py-2 px-3 border border-slate-300 font-mono"><?php echo e($u->sertifikasi_halal ?? '-'); ?></td>
                                <td class="py-2 px-3 border border-slate-300 text-slate-600"><?php echo e($u->jenis_usaha); ?></td>
                                <td class="py-2 px-3 border border-slate-300"><?php echo e($u->desa); ?></td>
                                <td class="py-2 px-3 border border-slate-300 text-slate-600"><?php echo e($u->alamat_lengkap); ?></td>
                                <td class="py-2 px-3 border border-slate-300 font-semibold"><?php echo e($u->nomor_telepon); ?></td>
                            </tr>
        ...
        <div class="mt-16 grid grid-cols-2 gap-8 text-xs font-semibold">
            ...
            <div class="space-y-16">
                <div class="space-y-1 text-center">
                    <p>Cicalengka, <?php echo e(date('d F Y')); ?></p>
...
<?php /**PATH C:\Users\ADVAN\Downloads\sipanda\resources\views/admin/laporan.blade.php ENDPATH**/ ?>