...
<div class="space-y-8 animate-fadeIn">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-5">
        <!-- 1. Total Pengajuan -->
        <a href="<?php echo e(route('admin.pengajuan')); ?>" class="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm hover:border-slate-350 hover:shadow-md transition-all duration-200 flex flex-col justify-between group">
            ...
            <div class="flex items-baseline justify-between mt-4">
                <span class="text-3xl font-black text-secondary-900"><?php echo e($stats['total_pengajuan']); ?></span>
        ...
        <a href="<?php echo e(route('admin.pengajuan', ['status' => 'Menunggu Verifikasi'])); ?>" class="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm hover:border-slate-350 hover:shadow-md transition-all duration-200 flex flex-col justify-between group">
            ...
            <div class="flex items-baseline justify-between mt-4">
                <span class="text-3xl font-black text-amber-600"><?php echo e($stats['menunggu']); ?></span>
        ...
        <!-- 3. Perlu Perbaikan -->
        <a href="<?php echo e(route('admin.pengajuan', ['status' => 'Perlu Perbaikan'])); ?>" class="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm hover:border-slate-350 hover:shadow-md transition-all duration-200 flex flex-col justify-between group">
            ...
            <div class="flex items-baseline justify-between mt-4">
                <span class="text-3xl font-black text-orange-600"><?php echo e($stats['perbaikan']); ?></span>
        ...
        <!-- 4. Disetujui -->
        <a href="<?php echo e(route('admin.pengajuan', ['status' => 'Disetujui'])); ?>" class="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm hover:border-slate-350 hover:shadow-md transition-all duration-200 flex flex-col justify-between group">
            ...
            <div class="flex items-baseline justify-between mt-4">
                <span class="text-3xl font-black text-green-600"><?php echo e($stats['disetujui']); ?></span>
        ...
        <!-- 5. Ditolak -->
        <a href="<?php echo e(route('admin.pengajuan', ['status' => 'Ditolak'])); ?>" class="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm hover:border-slate-350 hover:shadow-md transition-all duration-200 flex flex-col justify-between group">
            ...
            <div class="flex items-baseline justify-between mt-4">
                <span class="text-3xl font-black text-red-600"><?php echo e($stats['ditolak']); ?></span>
        ...
        <!-- 6. Terdaftar Resmi -->
        <a href="<?php echo e(route('admin.umkm')); ?>" class="bg-gradient-to-tr from-primary-600 to-emerald-500 text-white p-5 rounded-2xl shadow-md hover:shadow-lg hover:scale-[1.02] transition-all duration-200 flex flex-col justify-between group">
            <span class="text-xs text-primary-100 font-bold uppercase tracking-wider block">UMKM Terdaftar</span>
            <div class="flex items-baseline justify-between mt-4">
                <span class="text-3xl font-black text-white"><?php echo e($stats['total_umkm']); ?></span>
    ...
    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
        <div class="p-6 border-b border-slate-100 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.pengajuan')); ?>" class="text-xs font-bold text-primary-600 hover:text-primary-700">
                Lihat Semua &rarr;
            </a>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADVAN\Downloads\sipanda\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>